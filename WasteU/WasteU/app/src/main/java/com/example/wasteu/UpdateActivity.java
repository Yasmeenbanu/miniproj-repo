...
public class UpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDataref=FirebaseDatabase.getInstance().getReference("userdata").child(cleanEmail(currentusr.getEmail()));
        ...
        mUpdt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dbRef = FirebaseDatabase.getInstance().getReference("userdata").child(cleanEmail(currentusr.getEmail()));
