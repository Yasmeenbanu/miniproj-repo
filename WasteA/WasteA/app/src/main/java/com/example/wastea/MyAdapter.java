...
class MyAdapter extends BaseAdapter {
    ...
    Context context;
    ComplaintGActivity mlistA;

    public MyAdapter(FragmentActivity activity, List<ModelFile> mList, ComplaintGActivity complaintGActivity) {
        this.modelFiles=mList;
        this.mlistA=complaintGActivity;
