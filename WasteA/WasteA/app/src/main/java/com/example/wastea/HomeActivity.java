...
public class HomeActivity extends AppCompatActivity
    ...
    private String dbRefPath = "/admindata";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mdloc=findViewById(R.id.dloc);
        mdloc.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (final DataSnapshot dsp : dataSnapshot.getChildren()) {
                    ...
                    localLat = savedLocation.Latitude;
                    localLng = savedLocation.Longitude;
                    Log.v("dddddd","datasss:"+savedLocation.Status);

                    if (savedLocation.Status.equals("Online")) {
