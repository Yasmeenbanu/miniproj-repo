...
Button mUpdt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDataref=FirebaseDatabase.getInstance().getReference("admindata").child(cleanEmail(currentusr.getEmail()));
...
Toast.makeText(UpdateActivity.this,"Data updated succesfully",Toast.LENGTH_LONG).show();
              ...
              dbRef = FirebaseDatabase.getInstance().getReference("admindata").child(cleanEmail(currentusr.getEmail()));
